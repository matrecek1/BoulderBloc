...
//direct Boulders
router.get('/boulders/get-boulders'); // gets all boulders
router.get('boulders/get-boulder/:boulderId'); // gets one boulder
router.put('/boulders/update-boulder/:boulderId'); // updates one boulder
router.delete('/boulders/delete-boulder/:boulderId'); // deletes one boulder
